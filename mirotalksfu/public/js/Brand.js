...
let BRAND = {
    app: {
        language: 'ru',
        name: 'ExCall',
        title: 'ExCall<br />Бесплатные видеозвонки в браузере.<br />Просто, Безопасно, Быстро.',
        description:
            'Начните ваш следующий видеозвонок одним кликом. Не нужны загрузки, плагины или регистрация. Просто начните общаться, обмениваться сообщениями и делиться экраном.',
